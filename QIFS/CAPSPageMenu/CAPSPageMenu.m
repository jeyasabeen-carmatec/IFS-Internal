...
- (instancetype)initWithViewControllers:(NSArray *)viewControllers frame:(CGRect)frame options:(NSDictionary *)options index:(NSInteger)index
{
    ...
    if (_menuScrollView.subviews.count == 0) {
        [self configureUserInterface:index];
    }
    return self;
}
...
- (void)configureUserInterface:(NSInteger)passIndex
{
